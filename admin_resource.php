...
<div class="container">
	...
	<div>
		...
		<button class=" btn btn-large" id=""><i class="icon-circle-arrow-up"></i><strong class = "text-info">上传</strong></button>
		<button class=" btn btn-large" id=""><i class="icon-download-alt"></i><strong class = "text-info">下载</strong></button>
		<button class=" btn btn-large" id=""><i class="icon-folder-open"></i><strong class = "text-info">新目录</strong></button>
		<button class=" btn btn-large" id=""><i class="icon-remove-sign"></i><strong class = "text-info">删除</strong></button>
		<button class=" btn btn-large" id=""><i class="icon-share-alt"></i><strong class = "text-info">移动</strong></button>
		<button class=" btn btn-large" id=""><i class="icon-file"></i><strong class = "text-info">复制</strong></button>
	</div>
	<hr>
	<div class="row">
		<div class="span6">
